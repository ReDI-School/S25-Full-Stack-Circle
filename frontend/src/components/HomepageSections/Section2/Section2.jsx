...
const Section2 = () =>{
  return (
    <div className={styles['preview-section-2']}>
            ...
            <div className={styles['section-text-p']}><p>Collect your favorites so you can get back to them later.</p></div>
            </div>
            <div className={styles['section2-images']}>
              <div className={styles["section2-grid-wrapper"]}>
                 <CardLarge />
                 <div className={`${styles["small-card"]} ${styles['medium']} ${styles['image1']}`}>
                    <p>My Scandinavian Bedroom</p>
                 </div>
                 <div className={`${styles["small-card"]} ${styles['small']} ${styles['image2']}`}>
                     <p>The deck of my dreams</p>
                 </div>
                 <div className={`${styles["small-card"]} ${styles['medium']} ${styles['image3']}`}>
