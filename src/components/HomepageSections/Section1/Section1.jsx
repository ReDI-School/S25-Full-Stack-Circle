              ...
              <div className={styles['preview-section-1']}>
                  ...
                  <div className={styles['section1-images']}>
                    ...
                    <div className={styles['image-layers-container']}>
                      ...
                      <img className={styles['stleyespreview-section1-layer1-img']} src={section1Image1} alt="Image 1" />
                      ...
                      <div><button className={styles['quickSearch-button']}><FiSearch/>easy chicken dinner</button></div>
                    </div>
                  </div>
